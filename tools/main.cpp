...
void print_help(const char* prog) {
    ...
    std::cout
        ...
        << "  -o, --output=PATH             " << wrap("Write template to PATH (default volley-scenario.yaml)", yellow()) << "\n\n"
...
constexpr std::string_view kTplMinimal = R"(# @generated by volley --init=minimal
...
constexpr std::string_view kTplEcommerce = R"(# @generated by volley --init=ecommerce
version: "1.0"
...
constexpr std::string_view kTplAuth = R"(# @generated by volley --init=auth
version: "1.0"
...
constexpr std::string_view kTplSpike = R"(# @generated by volley --init=spike
version: "1.0"
...
int do_init(const CliArgs& args) {
    ...
    std::string out_path = args.init_output.empty()
        ? std::string("volley-scenario.yaml") : args.init_output;
    ...
    std::cout << ok_label() << "Template validated OK (test_id=" << eng.config().test_id
              ...
              << info_label() << "Run it with: TARGET_URL=http://your-host volley --config="
...
const CliArgs& args,
    ...
    auto head = wrap("volley — Load Results", bright_cyan() + bold());
    std::cout << "\n" << head << "\n";
...
int run_direct(const CliArgs& args, security::AuthProvider& auth, otel::Tracer& tracer) {
    ...
    std::cout << wrap("volley Load Tester (direct mode)", bright_cyan() + bold()) << "\n"
...
int main(int argc, char* argv[]) {
    ...
    if (args.version) {
        std::cout << core::term::wrap(
            "volley " + std::string(core::kVersion),
    ...
    std::cout << core::term::wrap("volley Load Tester (scenario mode)",
                                  core::term::bright_cyan() + core::term::bold()) << "\n"
