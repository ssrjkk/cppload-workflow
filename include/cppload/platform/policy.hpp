...
private:
    [[nodiscard]] auto get_metric_value(const RunResult& r, const std::string& metric) const -> std::optional<double>;
    [[nodiscard]] auto check_threshold(double actual, const std::string& op, double threshold) const -> bool;
    [[nodiscard]] auto format_violation(const std::string& metric, const std::string& op,
