...
class TestVaultClient:
    ...
    def test_get_secret_success(self, mock_urlopen):
        ...
        mock_urlopen.side_effect = [
            MagicMock(__enter__=Mock(return_value=health_response), __exit__=Mock(return_value=False)),
            MagicMock(__enter__=Mock(return_value=secret_response), __exit__=Mock(return_value=False))
        ]
    ...
    def test_get_secret_not_found(self, mock_urlopen):
        ...
        mock_urlopen.side_effect = [
            MagicMock(__enter__=Mock(return_value=health_response), __exit__=Mock(return_value=False)),
            MagicMock(__enter__=Mock(return_value=mock_response), __exit__=Mock(return_value=False))
        ]
    ...
    def test_get_secret_map_success(self, mock_urlopen):
        ...
        secret_response = Mock()
        secret_response.read.return_value = b'{"data": {"data": {"user": "admin", "pass": "secret"}}}'
